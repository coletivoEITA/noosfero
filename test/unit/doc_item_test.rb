...
class DocItemTest < ActiveSupport::TestCase
  ...
  should 'translate images' do
    ...
    File.stubs(:exist?).with(Rails.root + '/public/images/doc/myimage.pt.png').returns(false)
    assert_equal doc.text, doc.html

    File.stubs(:exist?).with(Rails.root + '/public/images/doc/myimage.pt.png').returns(true)
  ...
  should 'replace images with the ones provided by the theme' do
    ...
    File.stubs(:exist?).with(Rails.root + '/public/images/doc/myimage.pt.png').returns(true)
    File.stubs(:exist?).with(Rails.root + '/public/designs/themes/mytheme/images/doc/myimage.pt.png').returns(true)
  ...
  should 'prefer system-provided translated image to theme-provided english one' do
    ...
    File.stubs(:exist?).with(Rails.root + '/public/images/doc/myimage.pt.png').returns(true)
    File.stubs(:exist?).with(Rails.root + '/public/designs/themes/mytheme/images/doc/myimage.en.png').returns(false)
    File.stubs(:exist?).with(Rails.root + '/public/designs/themes/mytheme/images/doc/myimage.pt.png').returns(false)
    # the one in the theme must be used
  ...
  should 'prefer theme-provided untranslated image if system does not have a translation' do
    ...
    File.stubs(:exist?).with(Rails.root + '/public/images/doc/myimage.en.png').returns(true)
    File.stubs(:exist?).with(Rails.root + '/public/images/doc/myimage.pt.png').returns(false)
    File.stubs(:exist?).with(Rails.root + '/public/designs/themes/mytheme/images/doc/myimage.en.png').returns(true)
    File.stubs(:exist?).with(Rails.root + '/public/designs/themes/mytheme/images/doc/myimage.pt.png').returns(false)
    # the one in the theme must be used
