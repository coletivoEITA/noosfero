class ProfileDesignController < BoxOrganizerController
  ...
  def available_blocks
    blocks = [ ProfileBlock, ArticleBlock, TagsBlock, RecentDocumentsBlock, ProfileInfoBlock, LinkListBlock,
    ...
    blocks += @plugins.dispatch(:profile_blocks, profile) if @plugins
